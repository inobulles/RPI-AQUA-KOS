...
LDFLAGS := -L$(SDKSTAGE)/opt/vc/lib/ -lbrcmGLESv2 -lbrcmEGL -lopenmaxil -lbcm_host -lvcos -lvchiq_arm -lpthread -lrt -lm -lilclient -Lsrc/libs/ilclient -L$(SDKSTAGE)/src/libs/vgfont -lvgfont -lfreetype -lz
